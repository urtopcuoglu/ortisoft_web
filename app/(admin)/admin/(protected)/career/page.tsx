  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-extrabold text-slate-900">Kariyer İlanları</h1>
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            ...
            {postings.map((posting) => (
              <tr key={posting.id} className="border-b border-slate-100 last:border-0">
                <td className="px-4 py-3 font-semibold text-slate-800">{posting.title}</td>
                <td className="px-4 py-3 text-slate-500">{posting.location}</td>
