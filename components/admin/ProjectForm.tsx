...
export default function ProjectForm({
  ...
  return (
    <form action={formAction} className="flex max-w-xl flex-col gap-5">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="mb-1.5 block text-sm font-semibold text-slate-700">
            Slug <span className="font-normal text-slate-400">(benzersiz)</span>
          </label>
      ...
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-slate-700">
          Teknoloji Yığını <span className="font-normal text-slate-400">(opsiyonel, her satıra bir tane)</span>
        </label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="mb-1.5 block text-sm font-semibold text-slate-700">Fon / Kaynak Etiketi</label>
          <input
            name="fundingLabel"
